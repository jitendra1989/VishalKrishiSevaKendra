class Admin::CastsController < Admin::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if false
        format.html { redirect_to admin_casts_path(@cast), notice: "Cast was successfully created." }
        format.json { render :show, status: :created, location: @cast }
      else
        format.html { redirect_to new_admin_cast_path(@cast), notice: "Error while create casts." }
