class Admin::ProductsController < Admin::ApplicationController
	...
	private
		def product_params
			params.require(:product).permit(:name, :code, :description, :product_type_id, :saleable_online, :price, :sale_price, :active, images_attributes:[:id, :name, :_destroy], category_ids: [], cross_sale_product_ids: [])
		end
