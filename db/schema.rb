...
ActiveRecord::Schema.define(version: 2021_07_21_094429) do
  ...
  create_table "cart_item_image_customisations", force: :cascade do |t|
    ...
    t.bigint "characteristic_image_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "workshop_image_logs", force: :cascade do |t|
    t.bigint "user_id"
    t.string "info"
    t.bigint "order_item_image_customisation_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "workshop_logs", force: :cascade do |t|
    t.bigint "user_id"
    t.string "info"
    t.bigint "order_item_customisation_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
